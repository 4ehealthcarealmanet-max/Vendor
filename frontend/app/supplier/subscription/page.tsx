...
const PLAN_FEATURES = [
  [
    ...
    "Basic RFQ bidding & responses",
    "Standard order fulfillment workflows",
    "Standard email support",
  ],
  [
    "Unlimited active product listings",
    "Unlimited RFQ responses & bidding",
  ...
  [
    ...
    "Subcontracting RFQ access & routing",
    "Bulk inventory CSV upload tools",
    "24/7 priority support & SLAs",
    "Custom sales reports & exporting",
  ],
]
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
        <SupplierNavbar active="subscription" />
        ...
        <section className="w-full px-4 sm:px-6 pt-10 sm:pt-12 pb-6 sm:pb-8 max-w-4xl mx-auto text-left">
          <div className="space-y-3 sm:space-y-4">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-[#0F172A] leading-tight">
              Choose the plan that fits <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">your supply scale</span>
            </h1>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-2xl">
              Unlock the MedVendor clinical marketplace, bid on verified procurement RFQs, access advanced order fulfillment tooling, and expand your commercial pipeline instantly.
            </p>
            ...
            <div className="flex items-start gap-3 rounded-xl border border-emerald-200/60 bg-emerald-50/70 p-3.5 shadow-sm">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] sm:text-[11px] text-emerald-700 leading-relaxed">
                  Thank you for partnering with MedVendor. You have unrestricted access to bid on RFQs, update your product catalog, and process buyer orders.
                </p>
              </div>
            </div>
          ) : (
            <div className="flex items-start gap-3 rounded-xl border border-amber-200/70 bg-amber-50/70 p-3.5 shadow-sm">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] sm:text-[11px] text-amber-700 leading-relaxed">
                  Please subscribe to a plan to start bidding on RFQs, managing your product catalog, and fulfilling orders.
                </p>
              </div>
            </div>
          )}
