        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 pb-8 border-b border-slate-100">
          ...
          <div className="flex flex-col items-start space-y-4 text-left">
            ...
            <ul className="flex flex-col space-y-2.5">
              {[
                { href: "/buyer/dashboard", label: "Dashboard Hub" },
                { href: "/buyer/products", label: "Marketplace Search" },
                { href: "/buyer/rfq", label: "RFQs & Bidding" },
                { href: "/buyer/orders", label: "Purchase Orders" },
              ].map(({ href, label }) => (
                <li key={label}>
                  <Link
                    href={href}
          ...
          <div className="flex flex-col items-start space-y-4 text-left">
            ...
            <ul className="flex flex-col space-y-2.5">
              {[
                { href: "/buyer/profile", label: "Profile Settings" },
                { href: "/buyer/subscription", label: "Membership Plans" },
              ].map(({ href, label }) => (
                <li key={label}>
                  <Link
                    href={href}
          ...
          <div className="flex flex-col items-start space-y-4 text-left">
            ...
            <ul className="flex flex-col space-y-2.5">
              {[
                { href: "mailto:support@pathyatech.com?subject=Buyer%20Support", label: "Help Desk Support" },
